...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *upsdb.MemDatabase {
	var provers []func(key []byte) *upsdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *upsdb.MemDatabase {
		proof := upsdb.NewMemDatabase()
