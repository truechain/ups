...
func TestOutGenesisJson(t *testing.T) {
	...
	b, _ := ioutil.ReadFile("E:\\truechain\\src\\github.com\\truechain\\truechain-engineering-code\\cmd\\gups\\genesis.json")
	...
	for i := 1; i <= 52; i++ {
		...
		e := ioutil.WriteFile("E:\\truechain\\src\\github.com\\truechain\\truechain-engineering-code\\cmd\\gups\\"+fmt.Sprintf("genesis_%s.json", strconv.Itoa(i)), bytes, os.ModePerm)
		if e != nil {
