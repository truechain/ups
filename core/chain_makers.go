...
func GenerateChain(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db upsdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
...
func GenerateChainWithReward(config *params.ChainConfig, parent *types.Block, engine consensus.Engine, db upsdb.Database, n int, gen func(int, *BlockGen)) ([]*types.Block, []types.Receipts) {
	if config == nil {
		config = params.TestChainConfig
	}
	blocks, receipts := make(types.Blocks, n), make([]types.Receipts, n)
...
func makeHeaderChain(parent *types.Header, n int, engine consensus.Engine, db upsdb.Database, seed int) []*types.Header {
...
func makeBlockChain(parent *types.Block, n int, engine consensus.Engine, db upsdb.Database, seed int) []*types.Block {
...
func NewCanonical(engine consensus.Engine, n int, full bool) (upsdb.Database, *BlockChain, error) {
